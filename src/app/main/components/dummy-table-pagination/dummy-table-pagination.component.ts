...
export class DummyTablePaginationComponent implements OnInit {
  ...
  @ViewChild('filterableHeaderTemplate', { static: true })
  filterableHeaderTemplate: TemplateRef<any>;
  @ViewChild('paginationTableItemTemplate', { static: true })
  paginationTableItemTemplate: TemplateRef<any>;
  ...
  protected prepareData(data: Array<Array<any>>) {
    ...
    console.log('this.data=vffffs=>', this.Apidata);

    // create new data from the service data
    let newData = [];
    data.forEach((dataRow) => {
      console.log('data==>', data);
      console.log('this.data==>', this.Apidata);
          ...
          new TableItem({
            ...
            template:
              typeof dataElement === 'string'
                ? undefined
                : this.paginationTableItemTemplate,
